 ...
 * 构造统一的Input格式
 */
import { Input, Point, SupportEvent } from '@any-touch/types';
import { SUPPORT_TOUCH, INPUT_END, INPUT_START, INPUT_CANCEL } from '@any-touch/shared';
import { getCenter } from '../../vector/src/index';
import Touch from './devices/Touch';
import Mouse from './devices/Mouse';
import Adapter from './devices/Abstract';
