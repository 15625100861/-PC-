import { CLIENT_X, CLIENT_Y, DIRECTION_UP, DIRECTION_DOWN, DIRECTION_RIGHT, DIRECTION_LEFT, NONE } from '@any-touch/shared';
import { directionString, Point, Vector } from '@any-touch/types';
